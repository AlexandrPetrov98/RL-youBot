...
This project is dedicated to solve the problem of reaching and grabing the "object" by KUKA youBot, guided by the distance and the angle info, using the depth camera and reinforcement learning approach.
